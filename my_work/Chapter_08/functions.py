...
# --- Импортирование модуля целиком (импорт всех фукций модуля making_pizzas.py)

# import making_pizzas

# making_pizzas.make_pizza(16, 'pepperoni')
# making_pizzas.make_pizza(12, 'pepperoni', 'extra cheese')


# --- Импорт конкретной фукции модуля (making_pizzas.py)
...
# --- Назначение псевдонима для функции (Alias)
